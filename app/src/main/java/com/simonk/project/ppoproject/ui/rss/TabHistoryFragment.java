...
import com.simonk.project.ppoproject.databinding.TabHistoryFragmentBinding;
...
import com.simonk.project.ppoproject.ui.rss.util.SourcesListAdapter;
        ...
        if (getArguments().getBoolean(SOURCE_ARGUMENT)) {
            ...
            adapter.setClickListener(new SourcesListAdapter.HistoryListViewHolder.ClickListener() {
                ...
                public void onLongClicked(View v, HistoryEntry historyEntry) {
                    ...
                    sourceDialogFragment.show(requireFragmentManager(), "SourceDialogFragment");
                }
            });
            mAdapter = adapter;
        } else {
